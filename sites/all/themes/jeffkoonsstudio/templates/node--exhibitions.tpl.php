...
?>
<!-- themes/jeffkoonsstudio/node exhibitions.tpl.php -->
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div id="jeffkoons-exhibitions-slideshow">
  <!-- view embed name exhibition_images_attachment  argument:--> <?php print '<!-- nid:'.$node->nid.'-->'; ?>

  <?php print views_embed_view('exhibition_images_attachment', 'page', $node->nid); ?>
  </div><!--end: jeffkoons-exhibitions-slideshow -->

 <header<?php print $header_attributes; ?>>
     
        <span<?php print $title_attributes; ?>>
          <span class= "jeffkoons-studio-title jeffkoons-exhibitions-title">
          <?php print $jeffkoons_exhibitions_page_title; ?><span>
        </span>
