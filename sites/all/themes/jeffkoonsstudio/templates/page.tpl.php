...
<!--
enter_1 = new Image(800,600);
enter_1.src = "/sites/default/files/splash.jpg";

enter_2 = new Image(800,600);
enter_2.src = "/sites/default/files/splash2.jpg";
//-->
</script>
          ...
          <<?php print $tag; ?> id="main-content">
            ...
            <?php if ($title || $primary_local_tasks || $secondary_local_tasks || $action_links = render($action_links)): ?>
              <header<?php print $content_header_attributes; ?>>
                ...
                <?php if ($title): ?>
                <span id="page-title" class="jeffkoons-studio-page-title "><?php print $title; ?></span>
